...
function App() {
  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-40 bg-gray-800 text-orange-500">
      <h1 className='text-white text-center my-6 text-2xl'>Password generator</h1>
      <div className="flex shadow rounded-lg overflow-hidden mb-4">
        <input
          type="text"
          value={password}
